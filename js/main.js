...
// var switch1 = new rageSwitch(document.getElementById('switch5'));
// var switch2 = new rageSwitch(document.getElementById('switch6'));
// var switch3 = new rageSwitch(document.getElementById('switch7'));
// var switch4 = new rageSwitch(document.getElementById('switch8'));
